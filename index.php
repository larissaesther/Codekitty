...
<?php include('nav.php')?>
      ...
      <main class="hero container" data-aos="fade-up" data-aos-delay="400">
        <div class="p"><h1><strong style="color: orange">CODEKITTY</strong><strong style="color: pink"> I LIKE</strong></p></div>
...
<!-- ABOUT -->
  <section id="about">
      <div id="about-content">
        <div data-aos="zoom-in" data-aos-delay="100" class="imgLin" style="widht: 500px, height: 600px" >
          <img src="images/linguagens.jpg" alt=""/>
        </div>
        ...
        <div id="about-description" data-aos="zoom-out-left" data-aos-delay="250">
          ...
          <p><a id="button" href="login.php">Clique aqui</a></p>
        </div>
      </div>
  </section>
